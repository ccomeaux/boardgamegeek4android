...
public interface BggService {
	...
	@GET("/xmlapi2/plays")
	Call<PlaysResponse> playsByDate(@Query("username") String username, @Query("mindate") String minDate, @Query("maxdate") String maxDate, @Query("subtype") String subtype);

	@GET("/xmlapi2/plays")
	Call<PlaysResponse> playsByGame(@Query("username") String username, @Query("id") int gameId);

	@GET("/xmlapi2/plays")
	Call<PlaysResponse> plays(@Query("username") String username, @Query("mindate") String minDate, @Query("maxdate") String maxDate, @Query("subtype") String subtype, @Query("page") int page);
