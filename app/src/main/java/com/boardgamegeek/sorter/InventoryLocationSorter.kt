...
class InventoryLocationSorter(context: Context) : CollectionSorter(context) {
    ...
    @StringRes
    override val descriptionId = R.string.collection_sort_inventory_location

    @StringRes
    public override val typeResource = R.string.collection_sort_type_inventory_location
