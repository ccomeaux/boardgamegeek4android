...
class ArtistCollectionAdapter : RecyclerView.Adapter<ArtistCollectionAdapter.DetailViewHolder>(), AutoUpdatableAdapter {
    init {
        setHasStableIds(true)
    }

    var items: List<ArtistGameEntity> by Delegates.observable(emptyList()) { _, old, new ->
    ...
    inner class DetailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(gameDetail: ArtistGameEntity?) {
