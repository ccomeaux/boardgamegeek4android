                    ...
                    if (it.moveToFirst()) {
                        do {
                            val item = CollectionItemEntity(
                                ...
                                gameYearPublished = it.getIntOrNull(6) ?: YEAR_UNKNOWN,
                                collectionYearPublished = it.getIntOrNull(7) ?: YEAR_UNKNOWN,
                                ...
                                wishListPriority = it.getIntOrNull(25) ?: WISHLIST_PRIORITY_UNKNOWN,
