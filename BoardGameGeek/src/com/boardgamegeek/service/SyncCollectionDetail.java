...
public class SyncCollectionDetail extends SyncTask {
	...
	private void fetchGames(Cursor cursor) throws IOException, XmlPullParserException {
	...
	private void fetchGames(List<String> ids) throws IOException, XmlPullParserException {
