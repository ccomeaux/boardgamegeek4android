...
public class DeleteFilters {
	public static void createDialog(final CollectionActivity activity) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(activity).setTitle(R.string.menu_collection_view_delete)
				.setCursor(cursor, new DialogInterface.OnClickListener() {
					...
					private void deleteFilters(final ContentResolver cr, Long filterId) {
						...
						if (count == 1) {
							Toast.makeText(activity, R.string.msg_collection_view_deleted, Toast.LENGTH_LONG).show();
						}
					}
