...
/**
 * Slightly more abstract {@link AsyncQueryHandler} that helps keep a {@link WeakReference} back to a listener. Will
 * properly close any {@link Cursor} if the listener ceases to exist.
 * <p>
...
public class NotifyingAsyncQueryHandler extends AsyncQueryHandler {
	...
	/**
	 * Assign the given {@link AsyncQueryListener} to receive query events from asynchronous calls. Will replace any
	 * existing listener.
	 */
	...
	/**
	 * Clear any {@link AsyncQueryListener} set through {@link #setQueryListener(AsyncQueryListener)}
	 */
	 ...
	 * {@link AsyncQueryListener#onQueryComplete(int, Object, Cursor)} is called if a valid {@link AsyncQueryListener}
	 * is present.
	 */
	 ...
	 * 
	 * @param token
	 *            Unique identifier passed through to {@link AsyncQueryListener#onQueryComplete(int, Object, Cursor)}
	 */
	 ...
	 * is present.
	 */
	public void startQuery(Uri uri, String[] projection, String orderBy) {
		startQuery(-1, null, uri, projection, null, null, orderBy);
	}
