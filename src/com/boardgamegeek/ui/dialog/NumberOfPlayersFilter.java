...
public class NumberOfPlayersFilter {
	...
	public void createDialog(final CollectionActivity activity) {
    	...
    	View layout = inflater.inflate(R.layout.dialog_num_players,
    	                               (ViewGroup) activity.findViewById(R.id.layout_root));
    	
    	final TextView text_interval = (TextView) layout.findViewById(R.id.text_interval);
			...
			public void onValuesChanged(boolean knobStartChanged,
				...
				if(!sliderView.isSecondThumbEnabled() && knobEndChanged)
					...
					if(knobStart == knobEnd)						
						...
						text_interval.setText(knobEnd + " - " + knobStart);
				}
			}
		});
