...
public class DeleteFilters {
	public static void createDialog(final CollectionActivity activity) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(activity)
				.setTitle(R.string.menu_collection_filter_delete).setCursor(cursor,
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, final int which) {
								AlertDialog ad = new AlertDialog.Builder(activity)
										.setTitle(R.string.are_you_sure_title)
										.setMessage(R.string.are_you_sure_delete_collection_filter)
										.setCancelable(false)
							...
							private void deleteFilters(final ContentResolver cr, Long filterId) {
								...
								if (count == 1) {
									Toast.makeText(activity, R.string.msg_collection_filter_deleted, Toast.LENGTH_LONG)
											.show();
								}
							}
